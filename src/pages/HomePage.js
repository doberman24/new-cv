            ...
            <div className="flex flex-grow items-center h-[600px]">
                ...
                <div className="flex flex-grow justify-center h-full">
                    <div className="flex flex-col justify-center max-w-[600px] text-gray-600">
                        ...
                        <p className="font-jura text-[1.1rem] leading-9 text-gray-500 font-medium my-4">Я начинающий front-end разрабочик, и уже начал свой путь в мире web-разработки. Моя цель - стать профессионалом в этой области и создавать удобные и функциональные интерфейсы для web-приложений и сайтов.</p>
