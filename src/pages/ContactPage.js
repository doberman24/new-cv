import { activeBtn, contactIcon } from "../config/AddElements";
                ...
                <article className="flex flex-col w-1/3 gap-y-12">
                    ...
                    <ul className="flex flex-col gap-y-12">
                        <li className="relative pl-16">
                            <span className="absolute left-0 text-[#ffa500]">{contactIcon.address}</span>
                        ...
                        <li className="relative pl-16">
                            <span className="absolute left-0 text-[#ffa500]">{contactIcon.email}</span>
                            <h4 className="uppercase text-lg font-medium text-neutral-500">Email</h4>
                            <b className="text-lg">doberman24@yandex.ru</b>
                        </li>
                        <li className="relative pl-16">
                            <span className="absolute left-0 text-[#ffa500]">{contactIcon.phone}</span>
                    ...
                    <div className="flex gap-x-5">
                        ...
                        <a href="https://vk.com/doberman242" target="_blank" rel="noopener noreferrer"
                            className="flex justify-center items-center rounded-full size-11 p-3 bg-neutral-200 dark:bg-neutral-700 duration-300 cursor-pointer hover:bg-neutral-300 dark:hover:bg-neutral-600"
                        >
                            <img className="opacity-60 dark:invert duration-300" src={require('../img/vk.png')} alt="" />
                        </a>
                        <a href="https://github.com/doberman24" target="_blank" rel="noopener noreferrer"
                            className="flex justify-center items-center rounded-full size-11 p-3 bg-neutral-200 dark:bg-neutral-700 duration-300 cursor-pointer hover:bg-neutral-300 dark:hover:bg-neutral-600"
                        >
                            <img className="opacity-60 dark:invert duration-300" src={require('../img/github.png')} alt="" />
                        </a>
                    </div>
                </article>
                <article className="w-2/3 min-w-96">
                    <form action="submit" className="flex w-full flex-col gap-y-8">
                        ...
                        <div className="fillMoreBtn effectFillMoreBtn relative flex bg-transparent border border-[#ffa500] h-14 w-60 justify-center items-center rounded-full mt-8"
                            onClick={() => console.log('Отправлено')}
                        >
                            <button className="font-Commissioner rounded-full uppercase font-bold flex flex-grow justify-center items-center h-full text-sm z-[1] focus:outline-none">Отправить</button>
