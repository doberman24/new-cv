...
const ContactPage = ({openModalAbout, modal}) => {
    ...
    return (
        <div className={`${modal ? '-z-10' : 'z-0'} duration-300 flex flex-col text-neutral-600 dark:text-neutral-400 relative w-[1180px] h-full xl-a:mx-10 md-a:ml-10 md-a:mr-28 mobile:mx-10 mx-2 animate-[startPages_0.5s_forwards]`}>
            ...
            <section className="flex flex-col md:flex-row gap-10 font-jura mb-36">
                <article className="flex flex-col w-full md:w-1/3 gap-y-8 sm:gap-y-12">
                    <h2 className="uppercase font-philosopher text-4xl md:text-3xl md-a:text-4xl font-semibold">Мои контакты</h2>
                    <ul className="flex flex-col gap-y-8 sm:gap-y-12">
                        <li className="relative pl-12 md-a:pl-16">
                            ...
                            <b className="text-base md-a:text-lg">Российская Федерация, город Санкт-Петербург</b>
                        </li>
                        <li className="relative pl-12 md-a:pl-16">
                            ...
                            <b className="text-base md-a:text-lg">doberman24@yandex.ru</b>
                        </li>
                        <li className="relative pl-12 md-a:pl-16">
                            ...
                            <b className="text-base md-a:text-lg">+7(921)-331-2439</b>
                        </li>
                    </ul>
                ...
                <article className="w-full md:w-2/3">
                    <form onSubmit={sendMail} method="post" className="flex w-full flex-col gap-y-5 mobile:gap-y-8">
                        <fieldset className="flex flex-nowrap flex-col sm:flex-row sm:gap-x-8 md:flex-col mobile:gap-y-8 gap-y-5 lg-a:flex-row lg:gap-x-8">
                            <label className="flex border-2 rounded-full flex-grow h-14 dark:border-neutral-600 bg-white duration-300 dark:bg-neutral-900">
                                <input className="rounded-full w-full px-7 bg-transparent focus:outline-[#ffa500] focus:outline-offset-0 outline-none dark:text-neutral-200 text-neutral-800 font-bold text-lg md:text-xl placeholder:text-base placeholder:uppercase placeholder:font-bold duration-300"
